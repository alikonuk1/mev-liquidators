...
interface IBaseSilo {
    ...
    function interestData(address _asset)
        external
        view
        returns (AssetInterestData memory);

    /// @dev helper method for InterestRateModel calculations
    function utilizationData(address _asset)
        external
        view
        returns (UtilizationData memory data);
    ...
    function depositPossible(address _asset, address _depositor)
        external
        view
        returns (bool);
    ...
    function borrowPossible(address _asset, address _borrower)
        external
        view
        returns (bool);

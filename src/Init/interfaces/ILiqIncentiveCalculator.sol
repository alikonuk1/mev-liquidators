...
interface ILiqIncentiveCalculator {
    event SetModeLiqIncentiveMultiplier_e18(uint16[] modes, uint256[] multipliers_e18);
    event SetTokenLiqIncentiveMultiplier_e18(address[] tokens, uint256[] multipliers_e18);
    event SetMaxLiqIncentiveMultiplier_e18(uint256 maxIncentiveMultiplier_e18);
    event SetMinLiqIncentiveMultiplier_e18(
        uint16[] modes, uint256[] minIncentiveMultipliers_e18
    );
    ...
    function minLiqIncentiveMultiplier_e18(uint16 _mode)
        external
        returns (uint256 minLiqIncentiveMultiplier_e18);
    ...
    function maxLiqIncentiveMultiplier_e18()
        external
        returns (uint256 maxLiqIncentiveMultiplier_e18);
    ...
    function modeLiqIncentiveMultiplier_e18(uint16 _mode)
        external
        returns (uint256 modeLiqIncentiveMultiplier_e18);
    ...
    function tokenLiqIncentiveMultiplier_e18(address _token)
        external
        returns (uint256 tokenLiqIncentiveMultiplier_e18);
    ...
    function getLiqIncentiveMultiplier_e18(
        uint16 _mode,
        uint256 _healthFactor_e18,
        address _repayToken,
        address _collToken
    ) external view returns (uint256 multiplier_e18);
    ...
    function setModeLiqIncentiveMultiplier_e18(
        uint16[] calldata _modes,
        uint256[] calldata _multipliers_e18
    ) external;
    ...
    function setTokenLiqIncentiveMultiplier_e18(
    ...
    function setMaxLiqIncentiveMultiplier_e18(uint256 _maxLiqIncentiveMultiplier_e18)
        external;
    ...
    function setMinLiqIncentiveMultiplier_e18(
        uint16[] calldata _modes,
        uint256[] calldata _minMultipliers_e18
    ) external;
}
